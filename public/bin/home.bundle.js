...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsClientIndexAboutme = __webpack_require__(159);

	var _componentsClientIndexAboutme2 = _interopRequireDefault(_componentsClientIndexAboutme);

	var _componentsClientIndexServices = __webpack_require__(160);

	var _componentsClientIndexServices2 = _interopRequireDefault(_componentsClientIndexServices);
	...
	var IndexComponent = _react2['default'].createClass({
	    ...
	    render: function render() {
	        return _react2['default'].createElement(
	            'div',
	            null,
	            _react2['default'].createElement(_componentsClientIndexAboutme2['default'], null),
	            _react2['default'].createElement(_componentsClientIndexServices2['default'], null)
	        );
	    }
	});

	_react2['default'].render(_react2['default'].createElement(IndexComponent, null), document.getElementById('root'));
